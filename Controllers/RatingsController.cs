...
namespace Paw_Day_Care.Controllers
{
    public class RatingsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("ratingId,UserId,PetSitterId,Score")] Rating rating)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ratingId,UserId,PetSitterId,Score")] Rating rating)
        {
